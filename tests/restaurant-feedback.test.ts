...
describe("restaurant feedback",()=>{
  ...
  it("provides a protected superadmin inbox",()=>{const page=readFileSync("src/app/superadmin/feedback/page.tsx","utf8");const layout=readFileSync("src/app/superadmin/layout.tsx","utf8");expect(page).toContain("requireSuperadmin()");expect(page).toContain("updateRestaurantFeedback");expect(layout).toContain('/superadmin/feedback')});
});
