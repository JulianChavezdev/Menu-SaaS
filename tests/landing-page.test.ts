...
describe("landing pública",()=>{
  it("incluye todas las secciones comerciales solicitadas",()=>{for(const id of["inicio","producto","como-funciona","precios","nosotros","faq","contacto"])expect(page).toContain(`id="${id}"`)});
