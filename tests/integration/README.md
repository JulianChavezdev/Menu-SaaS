...
La suite base usa la clave pública. Las pruebas protegidas usan la service role para crear datos temporales, validan aislamiento, límites, restauración e historial de slugs, y eliminan usuarios y restaurantes al finalizar. Si una migración requerida todavía no existe, la comprobación correspondiente se omite o falla señalando el esquema pendiente.
