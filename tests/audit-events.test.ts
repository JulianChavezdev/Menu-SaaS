...
describe("eventos de auditoría",()=>{
  it("clasifica y traduce eventos conocidos",()=>{
    ...
    expect(describeAuditEvent("platform.trash_cleanup_completed",{trialsExpired:1,processed:2,failed:0})).toMatchObject({group:"system",tone:"success",description:expect.stringContaining("1 pruebas vencidas")});
  });
