...
const expectedRecommendations=showcase.restaurants.flatMap(restaurant=>restaurant.products).reduce((total,product)=>total+(product.recommendations?.length??0),0);
...
if(count!==expectedRecommendations)throw new Error(`Se esperaban ${expectedRecommendations} recomendaciones y existen ${count??0}.`);
