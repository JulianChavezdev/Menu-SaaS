...
export default async function Page(){
  ...
  return <main className="mx-auto max-w-5xl p-4 md:p-6">
    ...
    <div className="my-6"><h1 className="text-2xl font-extrabold">Apariencia</h1><p className="mt-1 text-sm text-slate-400">Configura el logo, previsualiza las plantillas y elige los controles de la carta pública.</p></div>
