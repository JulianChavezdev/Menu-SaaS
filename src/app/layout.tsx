...
export default function Layout({children}:{children:React.ReactNode}){
  ...
  return <html lang="es"><head><link rel="preconnect" href={mediaOrigin} crossOrigin="anonymous"/><link rel="dns-prefetch" href={mediaOrigin}/></head><body>{children}<Toaster richColors/></body></html>;
}
