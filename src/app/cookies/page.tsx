...
export default function CookiesPage(){const identity=getLegalIdentity();if(!identity.complete)notFound();return <LegalPage title="Política de cookies y almacenamiento local" summary="Menuly no utiliza cookies publicitarias ni de seguimiento. Aquí se detallan los almacenamientos técnicos necesarios." identity={identity}>
  ...
  <LegalSection title="2. Carrito de la carta pública"><p>La carta guarda el carrito en el almacenamiento local del navegador bajo una clave asociada al restaurante. Incluye productos, cantidades y observaciones y permanece hasta que se vacía o se borran los datos del navegador. En restaurantes con Menuly Pedidos, estos datos solo se transmiten al servidor y a cocina cuando el comensal pulsa expresamente «Enviar pedido» desde una sesión de mesa activa.</p></LegalSection>
  <LegalSection title="3. Multimedia y terceros"><p>El navegador puede almacenar temporalmente imágenes y vídeos para mejorar la reproducción. Al solicitar archivos a proveedores multimedia, estos reciben datos técnicos de conexión, como la IP y el navegador, necesarios para entregar el contenido. Menuly no incorpora cookies analíticas, publicitarias ni perfiles comerciales.</p></LegalSection>
