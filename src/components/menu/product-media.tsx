...
type Props={index:number;name:string;src:string|null;poster:string|null;muted:boolean;preload:"none"|"metadata"|"auto";active:boolean;reducedMotion:boolean;playbackBlocked:boolean;setVideoRef:(element:HTMLVideoElement|null)=>void;onPlaybackStarted:(index:number)=>void};

export function ProductMedia({index,name,src,poster,muted,preload,active,reducedMotion,playbackBlocked,setVideoRef,onPlaybackStarted}:Props){
