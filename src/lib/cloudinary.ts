...
export function cloudinaryVideoPosterUrl(publicId:string){const config=configuredCloudinary();if(!config)throw new Error("Cloudinary no está configurado.");return config.client.url(publicId,{resource_type:"video",secure:true,format:"jpg",transformation:[{width:720,height:1280,crop:"fill",gravity:"auto",start_offset:"0.1",quality:"auto:good"}]})}
